...
class AgtNotificationsService {
  Future<AgtNotificationsModel> agtNotifications(
      // required BuildContext context,
      ) async {
    try {
      var token = AgentPreference.getPhoneToken();

      String serviceUrl = kNotificationsUrl;
      ...
      if (response.statusCode == 200) {
        ...
        return AgtNotificationsModel.fromJson(result);
