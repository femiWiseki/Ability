...
class AgtWithdrawalHistoryService {
  Future<AgtWithdrawalHistoryModel> agtTransHistoryService(
      // required BuildContext context,
      ) async {
    try {
      var token = AgentPreference.getPhoneToken();

      String serviceUrl = kAgtWithdrawalHistoryUrl;
      ...
      if (response.statusCode == 200) {
        ...
        return AgtWithdrawalHistoryModel.fromJson(result);
