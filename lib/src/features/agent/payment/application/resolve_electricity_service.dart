...
import 'package:ability/src/features/agent/payment/presentation/widgets/electricity_screens/electricity_name_screen.dart';
import 'package:ability/src/utils/user_preference/user_preference.dart';
import 'package:flutter/cupertino.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';
import 'package:http/http.dart' as http;

class ResolveElectricityService extends StateNotifier<bool> {
  ResolveElectricityService() : super(false);
  ...
  electricityService({
    ...
    try {
      ...
      String serviceUrl = kResolveElectricityUrl;
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        final electAccountName = result['data']['billItem']['name'];

        await AgentPreference.setElectAccountName(electAccountName);

        // Navigate to the next screen
        PageNavigator(ctx: context).nextPage(
            page: ElectricityNameScreen(
