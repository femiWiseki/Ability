...
class ElectricityListService {
  Future<ElectricityListModel> electricityList() async {
    try {
      var token = AgentPreference.getPhoneToken();

      String serviceUrl = kElectricityListUrl;
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        return ElectricityListModel.fromJson(result);
