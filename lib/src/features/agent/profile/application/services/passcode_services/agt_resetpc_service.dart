...
class AgtResetPasscodeService extends StateNotifier<bool> {
  AgtResetPasscodeService() : super(false);
  ...
  Future<void> resetPasscodeService({
    ...
    try {
      ...
      String serviceUrl = kAgtResetPasscodeUrl;
      ...
      if (response.statusCode == 200) {
        ...
        navigatorKey.currentState!.push(CupertinoPageRoute(
            builder: (context) =>
                AgtVerifyResetPasscode(ValidationHelper(), AgentController())));
        state = false;
      } else {
        final result = jsonDecode(response.body);
