...
class AgtConfirmNewPasscode extends ConsumerWidget {
  ValidationHelper validationHelper;
  AgentController agentController;
  AgtConfirmNewPasscode(this.validationHelper, this.agentController,
      {super.key});
                ...
                children: [
                  ...
                  Center(
                    child: GeneralPinCode(
                        ...
                        controller: agentController.confirmNewPasscode,
                        validator: (value) => validationHelper
                            .validateConfirmNewPasscode(value!)),
                  ),
