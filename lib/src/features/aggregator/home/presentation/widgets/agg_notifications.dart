...
class AggNotifications extends ConsumerStatefulWidget {
  const AggNotifications({super.key});

  @override
  ConsumerState<AggNotifications> createState() => _AggNotificationsState();
}

class _AggNotificationsState extends ConsumerState<AggNotifications> {
  @override
