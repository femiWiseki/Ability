...
class AggHomeScreenBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final agtProfile = ref.watch(getAggProfileProvider);
    return Container(
      height: 330,
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          PageNavigator(ctx: context).nextPage(
                              page:
                                  AggBottomNavBar(indexProvider: indexNumber));
                        },
                ...
                InkWell(
                    onTap: () {
                      PageNavigator(ctx: context)
                          .nextPage(page: const AggNotifications());
                    },
                      ...
                      return SizedBox(
                        ...
                        child: Row(
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                FlutterClipboard.copy('0000000000')
                                    .then((value) {
                                  successMessage(
